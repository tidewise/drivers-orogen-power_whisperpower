...
#ifndef POWER_WHISPERPOWER_DCPOWERCUBETASK_TASK_HPP
#define POWER_WHISPERPOWER_DCPOWERCUBETASK_TASK_HPP

#include <power_whisperpower/DCPowerCube.hpp>
#include "power_whisperpower/DCPowerCubeTaskBase.hpp"

namespace power_whisperpower {
    /*! \class DCPowerCubeTask
     * \brief Driver component for the DC Cubes
     */
    class DCPowerCubeTask : public DCPowerCubeTaskBase
    {
        /** The base class is auto-generated by orogen to define the task's interface
         *
         * It is located in the .orogen/tasks folder
         */
        friend class DCPowerCubeTaskBase;
    ...
    public:
         ...
         *                      configure state.
         */
        DCPowerCubeTask(std::string const& name = "power_whisperpower::DCPowerCubeTask");
