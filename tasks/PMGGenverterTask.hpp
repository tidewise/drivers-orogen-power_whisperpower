...
#ifndef POWER_WHISPERPOWER_PMGGENVERTERTASK_TASK_HPP
#define POWER_WHISPERPOWER_PMGGENVERTERTASK_TASK_HPP
...
namespace power_whisperpower {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','power_whisperpower::PMGGenverterTask')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix
     argument.
     */
    class PMGGenverterTask : public PMGGenverterTaskBase {
    ...
    public:
         ...
         */
        PMGGenverterTask(
            std::string const& name = "power_whisperpower::PMGGenverterTask");

        /** Default deconstructor of PMGGenverterTask
         */
        ~PMGGenverterTask();
