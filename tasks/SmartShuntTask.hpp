...
#ifndef POWER_WHISPERPOWER_SMARTSHUNTTASK_TASK_HPP
#define POWER_WHISPERPOWER_SMARTSHUNTTASK_TASK_HPP

#include <power_whisperpower/SmartShunt.hpp>
#include "power_whisperpower/SmartShuntTaskBase.hpp"

namespace power_whisperpower {
    /*! \class SmartShuntTask
     * \brief Driver component for the Smart Shunt battery monitor
     */
    class SmartShuntTask : public SmartShuntTaskBase
    {
        /** The base class is auto-generated by orogen to define the task's interface
         *
         * It is located in the .orogen/tasks folder
         */
        friend class SmartShuntTaskBase;

    protected:
        SmartShunt m_driver;

    public:
        /** TaskContext constructor for SmartShuntTask
         ...
         *                      configure state.
         */
        SmartShuntTask(std::string const& name = "power_whisperpower::SmartShuntTask");
